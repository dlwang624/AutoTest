				      ...
				      DrawCircle:function(){
					       ...
					       if(!canvasSupport()){
							...
							function drawScreen(){
								...
								//百分比文字
								cxt.font="16px sans bold";
								cxt.textBaseline="middle";
								cxt.textAlign="center";
								cxt.fillStyle="#d93a49";
								var messT=tip*initM/angle;
								if(null==messT||""==messT||isNaN(messT)||"undefined"==messT){
									messT = 0;
								}
								/*if(drawOne!="ture"){
								...
								var mess=Number(messT).toFixed(2)+"%";
