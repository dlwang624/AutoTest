		...
		<div class="main">
			...
			<div class="main-content" style="padding-bottom:0px;">
				<div class="container-fluid">
					<div class="fl"><h3 class="page-title">编辑环境</h3></div>
...
<!-- 										<h3 class="panel-title">环境配置</h3> -->
									...
									<div class="mainContentDiv">
										<div class="contentDiv" style="width:50%;">
											<input name="id" value="${ ambient.id}" type="text" class="none">
											<input name="qid" value="${ ambient.qid}" type="text" class="none">
											<input name="amtemp" value="${ ambient.amtemp}" type="text" class="none">
											
											<div class="mt10">
												<div class="fl w150 tr mr10 h30">描述信息</div>
												<div class="fl mr10 h30">:</div>
												<div class="fl">
													<input id="desc" name="amdesc" value="${ ambient.amdesc}" type="text" class="form-control">
												</div>
											</div>
											<div class="clearfix"></div>
											<div class="mt10">
												...
												<div class="fl mr10 h30">:</div>
												<div class="fl">
													<input id="url" name="amurl" value="${ ambient.amurl}" type="text" class="form-control">
												</div>
											</div>
											<div class="clearfix"></div>
											<div class="mt10 tr">
												<input id="editAmbient" value="更新" type="button"  class="btn btn-default">
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
...
$(function(){
	$("#editAmbient").click(function(){
		var id = $("input[name='id']").val();
		var qid = $("input[name='qid']").val();
		var temp = $("input[name='amtemp']").val();
		var desc = $("#desc").val();
		var url = $("#url").val();
		if(desc==""&&url==""){
		...
		$.ajax({
			 type: 'POST',
			  url: "switchambient/edit.htm",
			  data:{"id":id,"qid":qid,"amdesc":desc,"amurl":url,"amtemp":temp},
			  dataType: "json",
			  success: function(data){
				 if(data.msg){
					 layer.alert("环境更新成功",{icon:1});
				 }else{
					 layer.alert("环境更新失败",{icon:2});
				 }
			  },
