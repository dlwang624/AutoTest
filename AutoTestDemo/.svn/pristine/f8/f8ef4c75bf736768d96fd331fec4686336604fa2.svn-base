		...
		<div class="main">
			...
			<div class="main-content" style="padding-bottom:0px;">
				<div class="container-fluid clearfix">
					<div class="fl"><h3 class="page-title">更新测试用例</h3></div>
					<div class="fr">
						<input type="text" class="none" value="${ viewname}" id="viewname">
						<input type="text" class="none" value="${ statusflag}" id="statusflag">
														...
														<c:forEach items="${data.descList }" varStatus="status" var="desc">
															<tr id="row${status.index}">
															    ...
															    <td style="padding:0px;width:100px;">
															    	<select name="descList[${status.index}].type" data-value="${desc.type }" class="sync form-control" style="border:0;background: transparent;">
															    ...
															    <td style="padding:0px;"><input type="text" class="sync form-control" name="descList[${status.index}].description" style="width:100%;border:0;background: transparent;" value="${desc.description }" data-value="${desc.description }"/></td> 
															    <td style="padding:0px;"><input type="text" class="sync form-control" name="descList[${status.index}].resultdescription" style="width:100%;border:0;background: transparent;" value="${desc.resultdescription }" data-value="${desc.resultdescription }"/></td> 
																<td style="padding:0px;width: 100px;">
																	<select name="descList[${status.index}].resulttype" data-value="${ desc.resulttype}" class="sync form-control" style="border:0;background: transparent;">
