		...
		<div class="main">
			...
			<div class="main-content" style="padding-bottom:0px;">
				<div class="container-fluid">
					<div class="fl"><h3 class="page-title">添加公告</h3></div>
					...
					<div class="row">
							<div class="col-md-12">
								<div class="panel">
									...
									<!-- 添加文件夹main -->
									<form id="dynamicForm" action="maindata/synamic.htm" method="post" enctype="multipart/form-data">
									<div class="mainContentDiv">
										<div class="contentDiv" style="width:50%;">
											...
											<div class="mt10">
												...
												<div class="fl mr10 h30">:</div>
												<div class="fl">
													<textarea name="temp" class="form-control" rows="4" style="outline:none;resize:none;" maxlength="5000"></textarea>
												</div>
											</div>
											<div class="clearfix"></div>
											<div class="mt10">
											...
											<div class="clearfix"></div>
											<div class="mt10 tr">
												<button id="addworksynamic" class="btn btn-default" style="width:120px;">添加</button>
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
...
<script type="text/javascript" src="js/addSynamic.js"></script>
</body>
</html>